...
SRC_URI="https://github.com/tailscale/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"


src_compile() {
	go build -tags xversion -ldflags "-X tailscale.com/version.Long=${PV} -X tailscale.com/version.Short=${PV}" ./cmd/tailscale/
	go build -tags xversion -ldflags "-X tailscale.com/version.Long=${PV} -X tailscale.com/version.Short=${PV}" ./cmd/tailscaled/
}
