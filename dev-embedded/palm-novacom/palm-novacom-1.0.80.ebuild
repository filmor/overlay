...
SRC_URI="amd64? ( http://cdn.downloads.palm.com/sdkdownloads/${SDK_VERSION}/sdkBinaries/${PN}_${PV}_amd64.deb )
	x86? ( http://cdn.downloads.palm.com/sdkdownloads/${SDK_VERSION}/sdkBinaries/${PN}_${PV}_i386.deb )"
