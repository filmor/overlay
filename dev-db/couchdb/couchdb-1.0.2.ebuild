...
RDEPEND=">=dev-libs/icu-4.3.1
		...
		|| ( net-libs/xulrunner dev-lang/spidermonkey )"
...
src_configure() {
	econf \
		...
		--localstatedir=/var \
		--with-js-lib=$(pkg-config --variable=sdkdir mozilla-js)/lib \
		--with-js-include=$(pkg-config --variable=includedir mozilla-js)
