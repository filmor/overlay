...
SRC_URI="http://xbmc.svn.sourceforge.net/viewvc/xbmc/tags/Dharma_beta1/?view=tar -> ${PN}-Dharma_beta1.tar.gz"
KEYWORDS="~amd64 ~x86"
S=${WORKDIR}/Dharma_beta1

DESCRIPTION="XBMC is a free and open source media-player and entertainment hub - Dharma Beta1"
